...
(function ($) {
    ...
    PopoverX.prototype = $.extend({}, $.fn.modal.Constructor.prototype, {
        ...
        init: function () {
            ...
            // $dialog.on('mouseover.dismiss.popoverX', '[data-dismiss="popover-x"]', $.proxy(self.hide, self));
    ...
    $(document).ready(function () {
        $(document).on('mouseover tap', '[data-toggle="popover-x"]', function (e) {
            ...
            //$dialog.trigger('mousehover.target.popoverX');
            if (option !== 'toggle') {
                option.$target = $this;
                $dialog
                    .popoverX(option)
   ...
   $(".rslides_container,.main-content").on('mouseover',function(){
                $dialog.popoverX('hide');

            });


            $(document).not('.popover').tap('[data-toggle="popover-x"]', function (e) {
                $dialog.popoverX('hide');
            });
